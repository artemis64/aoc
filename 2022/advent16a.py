...
toCheck = [[0, 0, 30, []]] # 0 - index valve, 1 - potential release, 2 - time remain, 3 indices of opened valves
maxPressure = 0
while len(toCheck) > 0:
	checking = toCheck.pop(0)
	if checking[1] > maxPressure:
		maxPressure = checking[1]
	for gointTo in nonZeroValves:
